...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChangePermissions', function() {
      beforeEach(function() {
        instance = new Woden.ChangePermissions();
      });

      it('should create an instance of ChangePermissions', function() {
        // TODO: update the code to test ChangePermissions
        expect(instance).to.be.a(Woden.ChangePermissions);
      });
