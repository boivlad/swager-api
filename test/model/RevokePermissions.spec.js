...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RevokePermissions', function() {
      beforeEach(function() {
        instance = new Woden.RevokePermissions();
      });

      it('should create an instance of RevokePermissions', function() {
        // TODO: update the code to test RevokePermissions
        expect(instance).to.be.a(Woden.RevokePermissions);
      });
